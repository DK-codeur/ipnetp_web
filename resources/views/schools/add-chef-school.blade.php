...
@section('title', 'Ajouter Nouveau chef d\'Etablissement')
        ...
        <div class="container-fluid">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title">Ajouter un chef d'etablissement</h4>
                    </div>

                    <div class="col-sm-6">
                        <a href="{{route('chefSchools.index')}}"><button type="button" class="btn btn-primary btn-sm waves-effect waves-light"><span>
                            <i class="far fa-save"></i></span> Liste des Chefs d'etablissement</button>
                        </a>
                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body wizard-content">
                            <form action="{{route('chefSchools.store')}}" method="POST" enctype="multipart/form-data" class="validation-wizard wizard-circle m-t-40">
                                {{ csrf_field() }}
                                <section>
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="wemail"> Date d'entree en service <span class="danger">*</span> </label>
                                                <input type="date" class="form-control required" id="wemailAddress2" name="date_service">
                                                {!! $errors->first('date_service', '<small id="helpId" class="text-danger">:message</small>') !!}
                                            </div>
                                        </div>
                                    </div>
